      ...
      <SafeAreaView style={{ flex: 1 }}>
        <View style={styles.content}>
          <View style={styles.card}>
            {/* Category Header Section for Streetlight */}
            <View style={styles.row}>
              <View style={styles.streetlightBadge}>
                <Ionicons name="bulb" size={20} color="#CA8A04" />
              </View>
              <View>
                <ThemedText style={styles.label}>Category</ThemedText>
                <ThemedText style={styles.value}>streetlight</ThemedText>
              </View>
            </View>
...
const styles = StyleSheet.create({
  ...
  // Yellow theme for streetlights
  streetlightBadge: { backgroundColor: '#FEFCE8', padding: 10, borderRadius: 8 },
