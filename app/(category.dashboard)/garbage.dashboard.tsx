      ...
      <SafeAreaView style={{ flex: 1 }}>
        <View style={styles.content}>
          <View style={styles.card}>
            {/* Category Header Section for Garbage */}
            <View style={styles.row}>
              <View style={styles.garbageBadge}>
                <Ionicons name="trash" size={20} color="#16A34A" />
              </View>
              <View>
                <ThemedText style={styles.label}>Category</ThemedText>
                <ThemedText style={styles.value}>garbage</ThemedText>
              </View>
            </View>
...
const styles = StyleSheet.create({
  ...
  garbageBadge: { backgroundColor: '#DCFCE7', padding: 10, borderRadius: 8 },
