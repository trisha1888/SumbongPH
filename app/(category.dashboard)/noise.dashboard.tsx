      ...
      <SafeAreaView style={{ flex: 1 }}>
        <View style={styles.content}>
          <View style={styles.card}>
            {/* Category Header Section for Noise */}
            <View style={styles.row}>
              <View style={styles.noiseBadge}>
                <Ionicons name="volume-high" size={20} color="#9333EA" />
              </View>
              <View>
                <ThemedText style={styles.label}>Category</ThemedText>
                <ThemedText style={styles.value}>noise</ThemedText>
              </View>
            </View>
...
const styles = StyleSheet.create({
  ...
  // Purple theme for noise complaints
  noiseBadge: { backgroundColor: '#FAF5FF', padding: 10, borderRadius: 8 },
