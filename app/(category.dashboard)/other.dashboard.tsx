      ...
      <SafeAreaView style={{ flex: 1 }}>
        <View style={styles.content}>
          <View style={styles.card}>
            {/* Category Header Section for Other issues */}
            <View style={styles.row}>
              ...
              <View>
                ...
                <ThemedText style={styles.value}>other</ThemedText>
              </View>
            </View>
...
const styles = StyleSheet.create({
  ...
  // Gray theme for miscellaneous reports
  otherBadge: { backgroundColor: '#F9FAFB', padding: 10, borderRadius: 8, borderWidth: 1, borderColor: '#F3F4F6' },
