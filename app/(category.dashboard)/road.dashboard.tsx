          ...
          <View style={styles.card}>
            <View style={styles.row}>
              ...
              <View>
                ...
                <ThemedText style={styles.value}>road</ThemedText>
              </View>
            </View>
            <View style={styles.divider} />
            <View style={styles.section}><ThemedText style={styles.label}>Location</ThemedText><ThemedText style={styles.value}>Location not set</ThemedText></View>
            <View style={styles.section}><ThemedText style={styles.label}>Description</ThemedText><ThemedText style={styles.value}>No description provided</ThemedText></View>
            <View style={styles.section}>
              <ThemedText style={styles.label}>Urgency</ThemedText>
              <View style={styles.urgencyBadge}><ThemedText style={styles.urgencyText}>low</ThemedText></View>
            </View>
          </View>
          <TouchableOpacity style={styles.submitButton}><ThemedText style={styles.submitText}>Submit Report</ThemedText></TouchableOpacity>
          <TouchableOpacity style={styles.editButton}><ThemedText style={styles.editText}>Edit Details</ThemedText></TouchableOpacity>
        </View>
      </SafeAreaView>
    </ThemedView>
  );
...
const styles = StyleSheet.create({
  ...
  badge: { padding: 10, borderRadius: 8 },
